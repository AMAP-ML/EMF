...
class TextAlignedTokenizer(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.encoder_config = AutoConfig.from_pretrained('../google/siglip2-so400m-patch14-384',local_files_only=True,trust_remote_code=True)
        self.encoder = AutoModel.from_pretrained('../google/siglip2-so400m-patch14-384',config=self.encoder_config,local_files_only=True,trust_remote_code=True).vision_model     
