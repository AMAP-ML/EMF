...
#         unwrapped_model.current_step = state.global_step
#         unwrapped_model.max_steps = self.max_steps
...
class StepInjectorCallback(TrainerCallback):
    def on_step_begin(self, args, state, control, model=None, **kwargs):
        ...
        unwrapped.current_step = state.global_step
        unwrapped.max_steps    = state.max_steps or 1   # 由 Trainer 计算
...
class blip3oTrainer(Trainer):
    def __init__(self, *args, **kwargs):
        ...
        self.add_callback(StepInjectorCallback())   # 直接空参
