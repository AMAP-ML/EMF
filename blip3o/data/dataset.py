...
class LazySupervisedMixDataset(Dataset):
    ...
    def __init__(
        ...
        # sft
        jpg_files=[
            '../BLIP3o/SFT_60K_data/processed/*.tar',
        ]

        train_dataset = load_dataset("webdataset", data_files=jpg_files, split="train", num_proc=32, cache_dir=cache_dir_path)
        ...
        # # Echo-4o-Image
        data_root = "../Echo-4o-Image/Instruction-Following-Image/images-processed'
        tar_list = sorted(glob.glob(f'{data_root}/*.tar.gz'))
        train_dataset = load_dataset("webdataset", data_files=tar_list, split="train", num_proc=32, cache_dir=cache_dir_path)
        train_dataset = train_dataset.rename_column("jpg", "image")
        ...
        # # sharegpt
        train_dataset = load_dataset("webdataset", data_files='../FreedomIntelligence/ShareGPT-4o-Image-processed/text_to_image_part_*.tar', split="train", num_proc=32, cache_dir=cache_dir_path)
