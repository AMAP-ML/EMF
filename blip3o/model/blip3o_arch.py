...
from .multimodal_decoder.builder import build_sana, build_vae#, build_sana_zero
...
class blip3oMetaModel:
    ...
    def __init__(self, config):
        ...
        if hasattr(config, "mm_vision_tower"):
            ...
            self.sana = build_sana(config) # inference用
            
            # self.sana = build_sana_zero() #train from scratch用
